...
import org.rmj.cas.inventory.production.pojo.UnitDailyProductionMasterRM;
import org.rmj.appdriver.agentfx.callback.IMasterDetail;
import org.rmj.cas.inventory.base.InvExpiration;

public class DailyProductionRM{
    public DailyProductionRM(GRider foGRider, String fsBranchCD, boolean fbWithParent){
    ...
    public boolean BrowseRecord(String fsValue, boolean fbByCode){
        ...
        String lsColName = "a.sTransNox»a.dTransact»a.sRemarksx";
    ...
    public boolean addDetail() {
        if (paDetail.isEmpty()){
            ...
            paDetailOthers.add(new UnitDailyProductionInvOthers());
        } else{
            if (!paDetail.get(ItemCount()-1).getStockIDx().equals("") &&
                    Double.valueOf(String.valueOf(paDetail.get(ItemCount() -1).getQtyReqrd()))!= 0.00 &&
                    Double.valueOf(String.valueOf(paDetail.get(ItemCount() -1).getQtyUsed()))!= 0.00){
                paDetail.add(new UnitDailyProductionInv());
                paDetail.get(ItemCount() - 1).setDateExpiryDt(poGRider.getServerDate());
...
//        paDetail.get(ItemCount() - 1).setDateExpiryDt(poGRider.getServerDate());
    ...
    public boolean newTransaction() {
        ...
        poData = new UnitDailyProductionMasterRM();
    ...
    public UnitDailyProductionMasterRM loadTransaction(String fsTransNox) {
        UnitDailyProductionMasterRM loObject = new UnitDailyProductionMasterRM();
    ...
    private ArrayList<UnitDailyProductionInv> loadTransactionDetail(String fsTransNox){
    ...
    public boolean saveTransaction() {
        ...
        UnitDailyProductionMasterRM loOldEnt = null;
        UnitDailyProductionMasterRM loNewEnt = null;
        UnitDailyProductionMasterRM loResult = null;
        
        // Check for the value of foEntity
        if (!(poData instanceof UnitDailyProductionMasterRM)) {
            setErrMsg("Invalid Entity Passed as Parameter");
            return false;
        }
        
        // Typecast the Entity to this object
        loNewEnt = (UnitDailyProductionMasterRM) poData;        
    ...
    private boolean saveDetail(String fsTransNox){
        ...
        if (paDetail.isEmpty()){
            ...
            return false;
                ...
                paDetail.get(0).getQtyUsed()== (Number)0){
...
//                    loNewEnt.setDateExpiryDt(paDetail.get(lnCtr).getDateExpiryDt());
            ...
            ArrayList<UnitDailyProductionInv> laSubUnit = loadTransactionDetail(poData.getTransNox());
    ...
    public boolean deleteTransaction(String string) {
        UnitDailyProductionMasterRM loObject = loadTransaction(string);
...
//            if (lbResult) lbResult = saveInvTransSub();
        }
    ...
    private boolean saveInvTrans(){
        ...
        for (int lnCtr = 0; lnCtr <= paDetail.size() - 1; lnCtr ++){
            ...
            loInvTrans.setDetail(lnCtr, "nQuantity", paDetail.get(lnCtr).getQtyUsed());
        ...
        return saveInvExpiration(poData.getDateTransact());
    }
    ...
    private boolean saveInvExpiration(Date fdTransact){
        ...
        for (int lnCtr = 0; lnCtr <= paDetail.size() - 1; lnCtr ++){
            ...
            loInvTrans.setDetail(lnCtr, "nQtyOutxx", paDetail.get(lnCtr).getQtyUsed());
        }
    ...
    public String getSQ_Master() {
        return MiscUtil.makeSelect(new UnitDailyProductionMasterRM());
    }
    ...
    private String getSQ_DailyProducton(){
        ...
        String lsSQL = "SELECT " +
                            ...
                            ", a.dTransact" + 
                            ", a.sRemarksx" +
                        " FROM Daily_Production_RM_Master a" + 
    ...
    private UnitDailyProductionMasterRM poData = new UnitDailyProductionMasterRM();
    private UnitDailyProductionInv poDetail = new UnitDailyProductionInv();
    private ArrayList<UnitDailyProductionInv> paDetail;
    private ArrayList<UnitDailyProductionInvOthers> paDetailOthers;
}
